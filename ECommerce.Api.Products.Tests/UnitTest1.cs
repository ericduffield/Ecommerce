...
namespace ECommerce.Api.Products.Tests
{
    public class ProductsServiceTest
    {
        ...
        public async Task GetProductsReturnsAllProducts()
        {
            ...
            var productsProvier = new ProductsProvider(dbContext, null, mapper);


            var product = await productsProvier.GetProductsAsync();
        ...
        public async Task GetProductsReturnsProductUsingValidId()
        {
            ...
            var product = await productsProvier.GetProductAsync(1);
